<template>
  <footer>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap:28">
      <div class="">
        ...
        <p class="text-white leading-loose tracking-wide w-full md:w-[80%]">
          ...
          repudiandae enim nihil alias et placeat asperiores nisi molestias
          quidem! Obcaecati cupiditate dolorum odit ullam illo enim, atque vero
          veritatis consequuntur.
        </p>
        <div class="flex justify-end md:justify-start -mt-7 md:mt-3">
          <img
            src="../assets/images/footer2-img.webp"
            alt=""
      ...
      >
        <div class="">
          ...
          <div class="flex flex-col gap-3">
            <a href="#" class="hober:underline hover:text-secondary"
              >About Us</a
            >
            <a href="#" class="hober:underline hover:text-secondary">Feature</a>
            <a href="#" class="hober:underline hover:text-secondary">Carear</a>
          </div>
        </div>
        <div class="">
          ...
          <div class="flex flex-col gap-3">
            <a href="#" class="hober:underline hover:text-secondary"
              >Our Team</a
            >
            <a href="#" class="hober:underline hover:text-secondary">Partner</a>
            <a href="#" class="hober:underline hover:text-secondary"
              >Question</a
            >
          </div>
        ...
        <div class="">
          ...
          <div class="flex flex-col gap-3">
            <a href="#" class="hober:underline hover:text-secondary">Support</a>
            <a href="#" class="hober:underline hover:text-secondary"
              >Feedback</a
            >
            <a href="#" class="hober:underline hover:text-secondary">Contact</a>
          </div>
        </div>
      </div>
    </div>
    <div class="grid place-items-center my-20 w-full">
      ...
      >
        &copy; Copyright, Halloweend 2025, All rights reserved
      </p>
    </div>
  </footer>
</template>
