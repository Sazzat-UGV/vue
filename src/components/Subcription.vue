    ...
    <div class="p-10">
      <div class="flex items-center justify-between">
        <div class="">
          ...
          <p class="test-base md:text-lg text-white md:w-full">
            Subscribe to our newsletters and stay update!
          </p>
        </div>
      ...
      <form action="" class="mt-14 w-full">
        <div class="h-16 md:h-20 w-full md:w-1/2 flex items-center">
          <input
            ...
            class="h-full flex-grow rounded-l-left px-3 md:px-6 text-sm md:text-lg"
          />
          <button
